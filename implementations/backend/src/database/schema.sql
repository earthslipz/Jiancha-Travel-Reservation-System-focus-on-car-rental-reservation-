...
ALTER TABLE cars ADD COLUMN IF NOT EXISTS is_promotion BOOLEAN DEFAULT FALSE;
...
INSERT IGNORE INTO cars (brand, model, type, license_plate, price_per_day, location) VALUES
